...
```{r lifecycle, fig.cap="Model Life Cycle, NRC 2007", out.width='50%', fig.align='center'}
...
Model frameworks may be at different stages of the model life cycle than the key runs described above, although to date WGSAM has received requests for review in the "Model Construction" phase. 
