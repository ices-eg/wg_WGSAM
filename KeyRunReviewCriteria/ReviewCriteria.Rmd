...
1. (if important to use--projection) All functional groups persist

1. (if important to use--projection) Model stabilizes for the last ~20 years of an unfished, unperturbed 80-100 year run

1. Hindcast period established where we have survey/assessment time series with error bounds (this will come from the keyrun itself and we will endorse for this period if appropriate)

1. Species groups totaling ~80% of system biomass should qualitatively match hindcast biomass trends (or species groups needed for model purpose)
