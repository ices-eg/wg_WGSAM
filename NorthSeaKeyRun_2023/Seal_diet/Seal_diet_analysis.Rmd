...
## Extract total consumption per quarter
  ss<-read_xlsx(path=file.path(fil),sheet="cons") %>% rename(prey=species.name)
  ss
...
- Sprat, which was present in the seal diet was added to other food because of the small total consumption in each year and the lack of length samples.  
