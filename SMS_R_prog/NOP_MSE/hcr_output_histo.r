...
# Year range for data included in the plot
first.year.on.plot<-first.year.in.mean    #2025    # years where output is independent of initial conditions and used as "equilibrium"
last.year.on.plot<-last.year.in.mean      #2037
...
#########################################
control<-read.FLSMS.control(dir=dir)
