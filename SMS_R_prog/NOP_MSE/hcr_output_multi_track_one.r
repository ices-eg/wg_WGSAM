...
Reps<-c(1,1)  # Select MCMC repetion
Iter<-c(1)  # Select Iterations within a MCMC Repetion
Iter<-seq(1,2)  # Select Iterations within a MCMC Repetion
...
#########################################
    control<-read.FLSMS.control(file='SMS.dat')
...
do.plot.forecast1(sp.plot=incl.sp,incl.prob=TRUE,incl.M2=F)
