make.OP.dat<-function(my.area='North Sea',my.last.year=2000,first.year.output=2000,do.indicators=F,stochastic.recruitment=0,recruit.adjust.CV=0, recruit.adjust.factor=1) {
