...
scenario<-"ConstantTAC_implUncer"
...
if (do.simulation) {
  ...
  if (scenario=="ConstantTAC_implUncer") {

    HCR@implementation["dist",1]<- 0 #  normal distributed error
