...
if (sum(SMS.control@species.info[,'predator'])>0) {
  tab_quarterly_data(data=Read.summary.data(),vari='ration',outfile='_tab_ration4.html',decimals=3,title=":   Eaten biomass (kg) for one individual")
  ...
  tab_quarterly_data(data=Read.summary.data(),vari='Lsea',outfile='_tab_Lsea.html',decimals=0,title=":   Mean length in the sea(mm)")
  tab_quarterly_data(data=Read.summary.data(),vari='M2',outfile='_tab_M2.html',decimals=3,title=":   Predation mortality (M2)")
  tab_quarterly_data(data=Read.summary.data(),vari='M1M2',outfile='_tab_M1M2.html',decimals=3,title=":   Natural mortality (M1+M2)")
