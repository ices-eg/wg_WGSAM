...
#########################################################################################
  ...
  #list.data.path           # the directory with data on list format
...
minimum.age.all.species<-SMS.control@first.age 
years<-c(1,1)
...
fill_data<-function() {
  n_ages<-maximum.age.all.species-minimum.age.all.species+1
  data.frame(   year=rep(years[1],n_ages),
                quarter=rep(1,n_ages),
                species=rep('OTH',n_ages),
                age=seq(minimum.age.all.species,maximum.age.all.species))
}
