...
The diet file requires pre-processing outside R using the following steps. Even running a "bash" chunk here is still running R `system2()`; I don't think this is worth it. Cant even count the columns without the fans kicking up.
