...
See [here](https://sgaichas.github.io/poseidon-dev/PerCapitaConsumption.html) for the calculation above for NOBA and CCA. And an update based on new calculations for total consumption based on PROD.nc below.
